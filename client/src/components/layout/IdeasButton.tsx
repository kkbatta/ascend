...
const defaultIdeas = {
  ...
  '/reports': [
    'Add AI-powered trend prediction for provider metrics',
    'Implement real-time revenue forecasting',
    'Create automated performance alerts system',
    'Add comparative analysis between providers',
    'Implement custom report builder with templates',
    'Create provider performance scorecards',
    'Add historical trend analysis dashboard',
    'Implement revenue optimization suggestions',
    'Create automated monthly performance reports',
    'Add market share analysis visualization',
    'Real-time commission tracking dashboard',
    'Provider relationship strength analyzer',
    'Sales pipeline optimization suggestions',
    'Team efficiency metrics dashboard',
    'Customer retention analysis tools'
  ],
  '/team-performance': [
    'Add team productivity heat maps',
    'Implement AI-driven coaching suggestions',
    'Create individual performance prediction models',
    'Add team collaboration analytics',
    'Implement skill gap analysis dashboard',
    'Create automated training recommendations',
    'Add peer performance benchmarking',
    'Implement team goal tracking system',
    'Create talent retention risk analysis',
    'Add performance improvement tracking',
    'Real-time team activity monitoring',
    'Career progression planning tools',
    'Team satisfaction metrics dashboard',
    'Cross-team collaboration analyzer',
    'Leadership potential identification system'
  ],
  '/business': [
    ...
    'Add market opportunity analyzer',
  ...
  '/associates': [
    'Add associate performance prediction',
    'Implement recruitment funnel analytics',
    'Create mentorship matching system',
    'Add skill development tracking',
    'Implement commission structure optimizer',
    'Create team building suggestions',
    'Add associate satisfaction surveys',
    ...
    'Client relationship strength analyzer',
